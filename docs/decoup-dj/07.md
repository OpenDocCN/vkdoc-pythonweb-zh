...
这个文件应该放在 Git repo 中，因为它将在部署阶段使用。现在让我们看看如何为生产准备我们的 Vue.js 应用程序。
...
![../images/505838_1_En_7_Chapter/505838_1_En_7_Fig1_HTML.jpg](../images/505838_1_En_7_Chapter/505838_1_En_7_Fig1_HTML.jpg)

图 7-1

Django 和 Vue.js 应用程序在生产中部署
