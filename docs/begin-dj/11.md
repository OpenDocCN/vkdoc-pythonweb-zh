...
Django admin 是一个用户友好的应用，用于管理链接到 Django 项目的关系数据库的内容。尽管 Django admin 在设置方面几乎毫不费力——如第 [1](01.html) 章所述——但在这一章中你将学到多种配置选项来创建更强大的 Django admin 显示和功能。
...
*   `admin/index.html`。-定义主页面上 Django 管理索引页面的布局–如图 [11-45](#Fig45) 所示–以及显示所有型号的应用索引的布局。
