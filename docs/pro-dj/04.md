...
因此，对于 Django 的观点与其他环境相比如何的问题，没有简单的答案，因为没有任何可靠的东西可以比较。不同背景的人可能对视图有不同的期望。坏消息是Django可能和他们中的任何一个都不一致。好消息是，一旦您开始使用 Django，视图的概念就有了明确的定义，所以在与其他 Django 开发人员交流时不会有什么困惑。
